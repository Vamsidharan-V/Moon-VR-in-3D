...
///   -> Set the script's Axis to MouseY in the inspector. (You want the camera to tilt up and down like a head. The character already turns.)
   ...
   //         transform.localPosition += cameraReference.transform.localRotation * Vector3(0,0,translationZ * 0.1f);
        }
     ...
     //       transform.localPosition += cameraReference.transform.localRotation * Vector3(translationX * 0.1f,0,0);
        }       
